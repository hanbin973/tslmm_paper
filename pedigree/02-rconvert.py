...
if __name__ == "__main__":
    ts = tszip.decompress("spatial-simulation.genealogies.trees")
    with open("spatial-simulation.phenotypes.pkl", 'rb') as file:    
    ...
    np.savetxt("spatial-simulation.phenotypes.txt", pheno)
