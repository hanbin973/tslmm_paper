...
if __name__ == "__main__":
    ...
    parser.add_argument(
            "--path", type=str, default="blup_infer/",
            help="Path to save result",
            )
    args = parser.parse_args()
    
    genealogies_path = args.inp_prefix + ".inferred.dated.trees"
    pheno_path = args.inp_prefix + ".phenotypes.pkl"
    ...
    # get blup
    blup_path = args.path + args.inp_prefix + ".blup.it." + args.it + ".npy"
